...
WORKING_DIR=$1
THEME_RESOURCES_DIR='theme-resources'
...
declare -a root=('abi' 'bionic' 'art' 'bootable' 'build' 'dalvik' 'development' 'device' 'external' 'frameworks' 'hardware' 'kernel' 'libcore' 'libnativehelper' 'manifest' 'ndk' 'out' 'packages' 'pdk' 'prebuilts'
                 'sdk' 'system' 'theme-resources' 'tools' 'vendor')
...
declare -a values=('all_search_engines.xml' 'appmsg_colors.xml' 'arrays.xml' 'attrs_manifest.xml' 'bookmarks_icons.xml' 'bools.xml' 'config.xml' 'defaults.xml' 'donottranslate.xml' 'donottranslate_config.xml'
                   ...
                   'donottranslate-search_engines.xml' 'du_arrays.xml' 'du_strings.xml' 'du_symbols.xml' 'ev_arrays.xml' 'ev_strings.xml' 'ev_symbols.xml' 'fractions.xml' 'ids.xml' 'integers.xml' 'internal.xml'
                   'keys.xml' 'lland_config.xml' 'lland_strings.xml' 'plurals.xml' 'public.xml' 'strings.xml' 'symbols.xml' 'vpi_attrs.xml' 'vpi_defaults.xml' 'cm_arrays.xml' 'cm_plurals.xml' 'cm_strings.xml' 
                   'custom_strings.xml' 'custom_arrays.xml' 'vpi__defaults.xml' 'vpi__attrs.xml' 'nontranslatables.xml' 'accountprovider.xml' 'constants.xml' 'codeaurora_strings.xml' 'filtershow_ids.xml' 
                   'filtershow_strings.xml' 'filtershow_values.xml' 'filtershow_values_attrs.xml')

declare -a core=('java' 'jni' 'tests' 'src')

declare -a theme_packages=('Calculator' 'Calendar' 'Camera2' 'Contacts' 'ContactsCommon' 'DeskClock' 'Dialer' 'EVToolbox'
                           'EVUpdater' 'ExactCalculator' 'Gallery2' 'Launcher3' 'Messaging' 'PhoneCommon' 'Settings' 'Stk' 'Sudo')
...
git clone https://github.com/elginsk8r/theme-resources.git
...
rm -rf $THEME_RESOURCES_DIR/frameworks
mkdir $THEME_RESOURCES_DIR/packages
mkdir $THEME_RESOURCES_DIR/packages/apps
mkdir $THEME_RESOURCES_DIR/packages/apps/Dialer
mkdir $THEME_RESOURCES_DIR/packages/apps/Dialer/InCallUI
...
cd $WORKING_DIR/$THEME_RESOURCES_DIR/packages/apps/Dialer/InCallUI
delete_useless ${res[@]}
cd $WORKING_DIR/$THEME_RESOURCES_DIR
